                ...
                <table class="table align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('laporan.kehadiran.export', ['id_kelas' => $kls->id_kelas, 'bulan' => \Carbon\Carbon::parse($tanggal)->format('Y-m')]) }}" class="btn-excel" title="Export Kehadiran">
                                    <i class="fa-solid fa-file-excel"></i>
                                </a>
                            </td>
                            <td>
                                <a href="{{ route('laporan.penjemputan.export', ['id_kelas' => $kls->id_kelas, 'bulan' => \Carbon\Carbon::parse($tanggal)->format('Y-m')]) }}" class="btn-excel" title="Export Penjemputan">
                                    <i class="fa-solid fa-file-excel"></i>
                                </a>
                            </td>
                        </tr>
