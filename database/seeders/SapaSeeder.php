...
class SapaSeeder extends Seeder
{
    public function run()
    {
        ...
        DB::table('users')->insert([
            ['id_role'=>1,'username'=>'admin','nama_lengkap'=>'Admin','password'=>bcrypt('123'),'status'=>'aktif'],
            ['id_role'=>2,'username'=>'guru1','nama_lengkap'=>'Siti Aisyah','password'=>bcrypt('123'),'status'=>'aktif'],
            ['id_role'=>2,'username'=>'guru2','nama_lengkap'=>'Ahmad Fauzi','password'=>bcrypt('123'),'status'=>'aktif'],
            ['id_role'=>3,'username'=>'kepsek','nama_lengkap'=>'Kepala Sekolah','password'=>bcrypt('123'),'status'=>'aktif'],
        ]);
        ...
        for ($i=1; $i<=50; $i++) {
            ...
            DB::table('wali')->insert([
                ...
                'fingerprint_id'=>$i,
                'no_hp'=>'08123'.str_pad($i,6,'0',STR_PAD_LEFT),
                'is_active'=>1
            ]);
        }
        ...
        for ($i=1; $i<=50; $i++) {
            for ($d=0; $d<30; $d++) {
                ...
                DB::table('kehadiran')->insert([
                    ...
                    'jam_masuk'=>$status=='hadir' ? '07:0'.rand(0,5).':00' : null,
                    'jam_keluar'=>$status=='hadir' ? '12:0'.rand(0,5).':00' : null,
                    'metode'=>'rfid',
                    'status_hadir'=>$status,
