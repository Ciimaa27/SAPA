...
class DataSiswaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.data-siswa', compact('siswa', 'total', 'kelas'));
    }
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            // UID RFID boleh kosong, tetapi jika diisi harus unik
    ...
    public function kenaikanKelas()
    {
        ...
        try {
            ...
            // ==========================
            $mapping = [
                '5A' => '6A', '5B' => '6B', '5C' => '6C', // kelas 5 -> 6
                '4A' => '5A', '4B' => '5B', '4C' => '5C', // kelas 4 -> 5
                '3A' => '4A', '3B' => '4B', '3C' => '4C', // kelas 3 -> 4
                '2A' => '3A', '2B' => '3B', '2C' => '3C', // kelas 2 -> 3
                '1A' => '2A', '1B' => '2B', '1C' => '2C', // kelas 1 -> 2
            ];
